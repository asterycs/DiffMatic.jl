...
DiffMatic is a package for computing derivatives of symbolic expressions in matrix form. Provided are methods for computing gradients, Jacobians, Hessians and general matrix derivatives.
